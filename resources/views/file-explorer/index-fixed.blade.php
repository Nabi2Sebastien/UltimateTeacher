...
function createModelFromPath(filePath, fileName) {
    console.log('createModelFromPath appelé avec:', filePath, fileName);
    ...
    console.log('Nom du modèle généré:', modelName);
...
document.addEventListener('DOMContentLoaded', function() {
    const navForm = document.querySelector('form[method="GET"]');
    if (navForm) {
